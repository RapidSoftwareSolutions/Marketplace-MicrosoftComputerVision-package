...
$app->post('/api/MicrosoftComputerVision/describeImage', function ($request, $response, $args) {
    ...
    $query = [];
    if(!empty($post_data['args']['maxCandidates'])) {
        $query['maxCandidates'] = $post_data['args']['maxCandidates'];
    }
    ...
    $query_str = $settings['api_url'] . 'describe';
